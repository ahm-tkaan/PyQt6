...
class GrafikUygulamasi(QWidget):
    def __init__(self):
        ...
        self.combobox.addItems([
            "1. Kütle Oranı", "2. Baranın Rijitliği", "3. Optimum TMD Frekansı", 
            "4. TMD Optimum Rijitliği", "5. TMD Optimum Sönüm Oranı", "6. Optimum TMD Sönüm Katsayısı"
        ])
